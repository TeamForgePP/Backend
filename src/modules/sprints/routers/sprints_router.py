...
@router.get(
    "", response_model=AllSprintsResponse, status_code=status.HTTP_200_OK, name="get sprints info"
)
...
@router.get(
    "/{sprint_id}", response_model=Sprint, status_code=status.HTTP_200_OK, name="get sprint by id"
)
...
@router.patch(
    "/{sprint_id}", response_model=BasicResponse, status_code=status.HTTP_200_OK, name="edit sprint"
)
...
@router.post(
    ...
    name="complete sprint and start new",
)
